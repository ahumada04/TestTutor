...
import static Final.testSettingsCtrl.answerkey;
import static Final.testSettingsCtrl.questionURLS;
...
public class testCtrl implements Initializable {
    ...
    private static int numCorrect=0; //used only to calc percentage Correct
    ...
    public void initialize(URL location, ResourceBundle resources) { //sets initial question
            try {
    ...
    private void testGrade()
    {
        ...
        percentCorrect= getPercent(numCorrect,totalQuestions) * 100; //alter to get more granular .00% percentage
    }
