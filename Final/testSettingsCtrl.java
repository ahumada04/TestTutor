...
import static Final.loginCtrl.userClass;
import static Final.newStudentCtrl.dbURL;
...
public class testSettingsCtrl implements Initializable {
    ...
    public void initialize(URL arg0, ResourceBundle arg1) {
        ...
        final int  itemsAvailable = 6;//for now is done by hand but in the future could be done via sql queery
